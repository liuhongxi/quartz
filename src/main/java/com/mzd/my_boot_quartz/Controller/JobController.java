...
public class JobController {
     ...
     * @return
     */
    @PostMapping(value = baseuri + "/addschedule")
    public Result save(QuartzBean quartz) throws Exception {
        if (quartz.getOldJobGroup() != null) {
            JobKey key = new JobKey(quartz.getOldJobName(), quartz.getOldJobGroup());
            scheduler.deleteJob(key);
        }
        System.out.println("description:   "+quartz.getDescription());
        System.out.println("cronExpression:   "+quartz.getCronExpression());
        System.out.println("jobClassName:   "+quartz.getJobClassName());
        System.out.println("jobName:   "+quartz.getJobName());
        System.out.println("jobGroup:   "+quartz.getJobGroup());
        //获取.class
        ...
        logger.info("新增任务:   "+quartz.getJobName());
    ...
    public Result trigger(QuartzBean quartz) throws Exception {
        ...
        logger.info("立即执行: "+quartz.getJobName());
        return new Result("200", "", null);
    }
     ...
     * @return
     */
    @PostMapping(value = baseuri + "/pauseschedule")
     ...
     * @return
     */
    @PostMapping(value = baseuri + "/deleteschedule")
